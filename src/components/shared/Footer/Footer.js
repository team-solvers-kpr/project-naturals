        ...
        <div>
          <div>
            <p className="aboutText">
              About Us|Contact Us|FAQs|Shop|Privacy Policy|Return Policy|T&C|
            </p>
          </div>
          <img src={borderElement} height={98} width={410} />
          <div className="map">
            <img src={mapImage} height={80} width={100} />
          </div>
          <div className="whiteText">
            <p>
              Atopia Aadit (8th floor), House-3, Road-1/A, Block-J , Baridhara,
              Dhaka-1212, Bangladesh
            </p>
            <h4>UK Office</h4>
            <p>
              The Arches Cranberry Lane <br /> London, E16 4BJ, United Kingdom.
            </p>
          </div>
          <div 
              data-aos="fade-up"
