            ...
            <div className="container signup-container mt-5">
                ...
                <div class="col-md-12 col-lg-4 col-xl-4 offset-xl-1">
                    ...
                    <div class="divider d-flex align-items-center my-4">
                        <h1 class="text-center fw-bold mb-0">Sign Up</h1>
                    </div>
                    <form >
                    ...
                    <div class="text-center text-lg-start mt-4 pt-2">
                        ...
                        <p class="small fw-bold mt-4 pt-1 mb-0">Login Your Account <Link to='/login'
                            class="link-success ms-1">Login Here</Link>
                        </p>
                    </div>
